        ...
        <div class="row">
            <div class="col-6">
                <div class="mb-4">
                    ...
                    <input id="imageUrl" type="text" class="form-control" placeholder="請輸入圖片連結" v-model="editProduct.imageUrl">
                </div>
                <img :src="editProduct.imageUrl" class="img-fluid">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-primary me-2" data-bs-dismiss="modal" @click="goBack">
                        取消
                    </button>
...
export default {
  ...
  methods: {
    ...
    EditProduct () {
      const url = `${VITE_URL}/v2/api/${VITE_PATH}/admin/product`

      axios.put(url, { data: this.tempProduct }).then((response) => {
